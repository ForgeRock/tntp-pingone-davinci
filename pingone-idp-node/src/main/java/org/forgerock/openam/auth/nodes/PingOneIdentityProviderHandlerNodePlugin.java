...
public class PingOneIdentityProviderHandlerNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(PingOneIdentityProviderHandlerNodePlugin.currentVersion, 
				Collections.singletonList(PingOneIdentityProviderHandlerNode.class));
	}
	...
	public String getPluginVersion() {
		return PingOneIdentityProviderHandlerNodePlugin.currentVersion;
	}
}
