...
import org.forgerock.am.marketplace.pingone.davinci.DaVinciNode;
import org.forgerock.am.marketplace.pingone.idp.PingOneIdentityProviderHandlerNode;
...
public class PingOnePlugin extends AbstractNodeAmPlugin {
	...
	static private String currentVersion = "0.0.16";
	...
	public void upgrade(String fromVersion) throws PluginException {
		...
		try {
			pluginTools.upgradeAuthNode(DaVinciNode.class);
			pluginTools.upgradeAuthNode(PingOneIdentityProviderHandlerNode.class);
		} catch (Exception e) {
